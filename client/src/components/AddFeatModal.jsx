...
export default function AddFeatModal({ isOpen, onClose, onAdd }) {
  ...
  return (
    <AnimatePresence>
      {isOpen && (
        <div 
          // 1. z-[100] para ganarle al Nav. 
          // 2. pb-32 para que el modal no quede detrás del menú en celular.
          // 3. onClick={onClose} cierra el modal si tocas lo oscuro.
        ...
        >
          <motion.div 
            ...
            // Evita que el modal se cierre si le picas adentro del formulario
